...
import { ContentBlock as ContentBlockComponent } from "..";

export default {
  text: "Content/ContentBlock",
  component: ContentBlockComponent,
} as ComponentMeta<typeof ContentBlockComponent>;

const Template: ComponentStory<typeof ContentBlockComponent> = (args) => (
...
const SvgHTML = (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      ...
      strokeWidth="2"
    />
    <circle cx="48.01" cy="28.552" r="6.483" stroke="#0085B3" strokeWidth="2" />
    <path
